...
export default function BatteryTrend({ events }: { events: Event[] }) {
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-4 gap-2 text-center">
                ...
                <div className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800">
                    ...
                    <div className="font-bold text-red-500">{min}%</div>
                </div>

                <div className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800">
                    <div className="text-xs text-gray-500">MAX</div>
                    <div className="font-bold text-green-500">{max}%</div>
                </div>
            ...
            <div className="w-full h-56">
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={data}>
                        ...
                        <Tooltip
                            formatter={(value: any) => `${Number(value)}%`} labelFormatter={(label, payload) =>
